...
if DiffCalculationMethod == 1
    disp('Starting calculation of the diffusion coefficient with the average method ...')
else
    disp('Starting calculation of the diffusion coefficient with the fit method ...')
end
disp(' ')
