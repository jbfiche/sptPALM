...
PushButtonSize_load_MTT = [150, 35];
EditSize_4 = [200, 35];
...
Width_Separation_Line4 = floor((PanelWidth_1 - PushButtonSize_load_MTT(1) - EditSize_4(1))/2);
...
h.LoadMTT = uicontrol(h.Panel_LoadingTracks, 'Style', 'pushbutton',...
    ...
    'Position', [Position_Width(2) Position_Height(3) PushButtonSize_load_MTT], 'FontWeight', 'bold');
...
h.Parallel_computing = uicontrol(h.Panel_Action, 'Style', 'checkbox',...
    'Value', 0,...
