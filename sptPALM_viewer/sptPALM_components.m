...
Width_Separation_Line1 = floor((PanelWidth_1 - 3*(TextSize_1(1) + EditSize_1(1)))/3);
...
Position_Width = [Width_Separation_Line1, ...
    ...
    Width_Separation_Line1+2*EditSize_1(1)+2*TextSize_1(1), ...
    Width_Separation_Line1+2*EditSize_1(1)+3*TextSize_1(1)];
...
uicontrol(h.Panel_LoadingTracks,'Style','text',...
    'String','Detector size (px)',...
    'HorizontalAlignment','right',...
    'Position',[Position_Width(5) Position_Height(1) TextSize_1]);

h.DetectorSize = uicontrol(h.Panel_LoadingTracks, 'Style', 'edit',...
    'String', '512',...
    'Position', [Position_Width(6) Position_Height(1) EditSize_1]);
...
h.TrackingSoftware = uicontrol(h.Panel_LoadingTracks, 'Style', 'popupmenu',...
    'String', {'TrackMate (spot csv)', 'TrackMate (xml)', 'TrackMate batch', 'MTT'}, 'FontWeight', 'bold', ...
    'Position', [Position_Width(1) Position_Height(2) PopupmenuSize]);

h.Data_FileName = uicontrol(h.Panel_LoadingTracks, 'Style', 'edit',...
    'String', '*_track.csv', ...
    'Position', [Position_Width(2) Position_Height(2) EditSize_2]);

h.LoadData = uicontrol(h.Panel_LoadingTracks, 'Style', 'pushbutton',...
    'String', 'Load TrackMate files',...
...
h.Saving_file_name = uicontrol(h.Panel_LoadingTracks, 'Style', 'edit',...
    'String', 'TrackMate_sptPALM_analysis.mat',...
