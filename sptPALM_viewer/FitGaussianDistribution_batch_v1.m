function [NbrGaussianFit, D_mean, varargout] = FitGaussianDistribution_batch_v1(LogDapp, MSD_all, FontSize, ax, Lmax, Traj, DiffCalculationMethod)
...
% Perform a first test using only one Gaussian
% --------------------------------------------
...
[fitobject, gof1, output] = fit(hist_Bin, hist_Values, Gaussian, 'start', [s0,X0,A0]);
...
% If the one-population fit is selected, calculate the MSD
% --------------------------------------------------------
