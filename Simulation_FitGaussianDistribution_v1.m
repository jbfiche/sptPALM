function [NbrGaussianFit, D_mean, varargout] = Simulation_FitGaussianDistribution_v1(LogDapp, MSD_all, FontSize, hPlot, Lmax, Traj)
...
for n = 1 : NbrGaussianFit
    ...
    if NbrGaussianFit>1 && n>1
        NewLine = sprintf('Fraction with the highest diffusion : %d%%', F);
        Title = char(Title, NewLine);
    end
end
